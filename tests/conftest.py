...
from app import AuthType, Citations, Projects, Sources, Users
...
@pytest.fixture
def mocked_citation_model(mocked_uuid):
    mocked_uuid = mocked_uuid()
    return Citations(
        str(mocked_uuid), str(mocked_uuid), "", "mla citation", "apa citation"
    )
